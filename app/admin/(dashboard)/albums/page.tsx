    ...
    <div className="space-y-6 max-w-5xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[#9CA3AF] text-sm mt-1">Manage your album catalogue.</p>
        </div>
        <button
          disabled
      ...
      <div className="bg-[#141414] border border-white/[0.06] rounded-2xl p-12 flex flex-col items-center justify-center text-center space-y-3">
        <Disc className="w-10 h-10 text-[#9CA3AF]" aria-hidden="true" />
        <p className="text-white font-semibold">No albums yet</p>
        <p className="text-[#9CA3AF] text-sm max-w-xs">
          Create an album to group your songs into a cohesive release.
        </p>
      </div>
    </div>
  );
